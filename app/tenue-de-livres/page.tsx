...
export default function TenueDeLivresPage() {
  ...
  async function loadDashboard(id: string, year: number) {
    ...
    const transactionRows = (transactions ?? []) as Array<
      Record<string, unknown> & TransactionRow
    >;

    const sortedTransactions = [...transactionRows]
      .sort((a, b) =>
        String(b.transaction_date ?? b.date ?? "").localeCompare(
    ...
    if (latestDocumentsError) {
      throw new Error(latestDocumentsError.message);
    }
  ...
  async function checkAccess(selected: Lang, year: number = selectedYear) {
    try {
      ...
      if (authError || !user) {
        ...
        window.location.replace(`/espace-client?lang=${selected}&next=${next}`);
        return;
      }
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        ...
        result = (await response.json().catch(() => ({}))) as SubscriptionResponse;
      ...
      try {
        sessionStorage.removeItem("bookkeeping_checkout_client_secret");
        sessionStorage.removeItem("bookkeeping_checkout_plan");
      } catch {
        // Rien à faire.
      }
  ...
  const text = {
    fr: {
      ...
      income: "Revenus",
      incomeDesc: "Ajoutez et consultez vos revenus d’entreprise.",
      expenses: "Dépenses",
      expensesDesc:
      ...
      confirming: "Paiement reçu. Activation de votre abonnement…",
      confirmingDesc:
    ...
    en: {
      ...
      dashboard: "Dashboard",
      income: "Income",
      incomeDesc: "Add and review your business income.",
      expenses: "Expenses",
      expensesDesc: "Add expenses and keep your supporting documents.",
      documents: "Documents",
      documentsDesc:
        "Upload invoices, receipts, statements and other documents.",
      taxes: "GST / QST",
      taxesDesc: "Track taxes collected and input tax credits on expenses.",
      periods: "Periods",
      periodsDesc: "View monthly, quarterly or annual periods.",
      ...
      confirming: "Payment received. Activating your subscription…",
      confirmingDesc:
      ...
      taxPrice: "$29.99",
      taxPeriod: "/ month",
      taxDesc: "For bookkeeping with GST and QST tracking.",
    ...
    es: {
      ...
      dashboard: "Panel",
      income: "Ingresos",
      incomeDesc: "Añada y consulte los ingresos de su empresa.",
      expenses: "Gastos",
      expensesDesc: "Añada sus gastos y conserve sus comprobantes.",
      ...
      periods: "Períodos",
      periodsDesc: "Consulte períodos mensuales, trimestrales o anuales.",
      ...
      confirming: "Pago recibido. Activando su suscripción…",
      confirmingDesc:
      ...
      taxPrice: "29,99 $",
      taxPeriod: "/ mes",
      taxDesc: "Para la contabilidad con seguimiento de GST y QST.",
    ...
    return (
      <main className="state-page">
        <section className="state-card">
          ...
          <div className="state-brand">ComptaNet Québec</div>
          <h1>{text.confirming}</h1>
          <p>{text.confirmingDesc}</p>
          ...
          <style jsx>{`
            ...
            .spinner {
              ...
              animation: comptanetSpin 0.8s linear infinite;
            }
    ...
    return (
      ...
      >
        ...
        >
          ...
          <button
            type="button"
            onClick={() => void checkAccess(lang, selectedYear)}
            style={{
              border: 0,
              borderRadius: 10,
              padding: "12px 18px",
  ...
  const taxBalance =
    taxTotals.gstCollected +
    taxTotals.qstCollected -
    taxTotals.gstCredits -
    taxTotals.qstCredits;

  const dashboardCopy = {
    fr: {
      recent: "Dernières transactions",
      seeAll: "Voir toutes",
      taxBox: `TPS / TVQ (${selectedYear})`,
      gstCollected: "TPS perçue",
      qstCollected: "TVQ perçue",
      gstCredits: "Crédits de TPS",
      qstCredits: "Crédits de TVQ",
      balance: "Solde à remettre",
      recentDocs: "Documents récents",
      company: "Mon entreprise",
      help: "Assistant ComptaNet",
      logout: "Se déconnecter",
      addIncome: "Ajouter un revenu",
      addExpense: "Ajouter une dépense",
      addDocument: "Ajouter un document",
      viewTaxes: "Voir la section TPS / TVQ",
      viewPeriods: "Voir les périodes",
      ...
      category: "Catégorie",
      amount: "Montant",
      noTransactions: "Aucune transaction confirmée pour cette année.",
      noDocuments: "Aucun document récent.",
      simple: "Comptabilité simple. Résultats clairs.",
    },
    en: {
      recent: "Latest transactions",
      seeAll: "View all",
      taxBox: `GST / QST (${selectedYear})`,
      gstCollected: "GST collected",
      qstCollected: "QST collected",
      gstCredits: "GST credits",
      qstCredits: "QST credits",
      balance: "Balance payable",
      recentDocs: "Recent documents",
      company: "My business",
      help: "ComptaNet Assistant",
      logout: "Sign out",
      ...
      category: "Category",
      amount: "Amount",
      noTransactions: "No confirmed transactions for this year.",
      noDocuments: "No recent documents.",
      simple: "Simple bookkeeping. Clear results.",
    },
    es: {
      ...
      gstCredits: "Créditos GST",
      qstCredits: "Créditos QST",
      balance: "Saldo a remitir",
      recentDocs: "Documentos recientes",
      company: "Mi empresa",
      help: "Asistente ComptaNet",
      logout: "Cerrar sesión",
      addIncome: "Añadir ingreso",
      addExpense: "Añadir gasto",
      addDocument: "Añadir documento",
      viewTaxes: "Ver GST / QST",
      viewPeriods: "Ver períodos",
      ...
      category: "Categoría",
      amount: "Importe",
      noTransactions: "No hay transacciones confirmadas para este año.",
      noDocuments: "No hay documentos recientes.",
      simple: "Contabilidad simple. Resultados claros.",
    },
  }[lang];
  ...
  const navItems = [
    ...
    },
    {
      icon: "%",
      label: text.taxes,
      href: `/tenue-de-livres/taxes?lang=${lang}&year=${selectedYear}`,
    },
    {
      icon: "▦",
      label: text.periods,
      href: `/tenue-de-livres/periodes?lang=${lang}&year=${selectedYear}`,
    },
    {
      icon: "▥",
      label: text.annual,
      href: `/tenue-de-livres/resume-annuel?lang=${lang}&year=${selectedYear}`,
    },
  ];
    ...
    <main className="bk-shell">
      <aside className={`bk-sidebar ${mobileMenuOpen ? "open" : ""}`}>
        <div className="bk-brand">
          <span className="bk-brandmark">▥</span>
          <div>
            <strong>ComptaNet Québec</strong>
            <small>{dashboardCopy.simple}</small>
          </div>
        </div>
        ...
        <div className="bk-sidebottom">
          ...
          >
            <span>▣</span>
            {dashboardCopy.company}
          </Link>

          <Link href={`/aide?lang=${lang}`}>
            <span>?</span>
            {dashboardCopy.help}
          </Link>
      ...
      <div className="bk-main">
        ...
        <div className="bk-content">
          ...
          <section className="bk-summarygrid">
            <Link
              href={`/tenue-de-livres/revenus?lang=${lang}&year=${selectedYear}`}
              className="bk-summary income"
            >
              <span className="bk-summaryicon">$</span>
              <div>
                <b>{text.incomeTotal}</b>
            ...
            <div className="bk-summary result">
              <span className="bk-summaryicon">▥</span>
              <div>
                <b>{text.profit}</b>
            ...
            <Link
              href={`/tenue-de-livres/documents?lang=${lang}&year=${selectedYear}`}
              className="bk-summary docs"
            >
              <span className="bk-summaryicon">▰</span>
              <div>
                <b>{text.documentsTotal}</b>
          ...
          <section className="bk-actiongrid">
            {cards.map((card, index) => {
              const buttons = [
                dashboardCopy.addIncome,
                dashboardCopy.addExpense,
                dashboardCopy.addDocument,
                dashboardCopy.viewTaxes,
                dashboardCopy.viewPeriods,
                dashboardCopy.generateSummary,
              ];
              ...
              return (
                <Link
                  ...
                  className="bk-action"
                >
                  <span className={`bk-actionicon i${index}`}>{card.icon}</span>
          ...
          <section className="bk-lowergrid">
            <div className="bk-panel bk-transactions">
              <div className="bk-panelhead">
                <h2>▣ {dashboardCopy.recent}</h2>
                <Link
                  href={`/tenue-de-livres/revenus?lang=${lang}&year=${selectedYear}`}
                >
                  {dashboardCopy.seeAll}
                </Link>
              </div>

              {recentTransactions.length === 0 ? (
                <div className="bk-empty">{dashboardCopy.noTransactions}</div>
              ) : (
                  ...
                  <table>
                    <thead>
                      <tr>
                        ...
                        <th>{dashboardCopy.type}</th>
                        <th>{dashboardCopy.description}</th>
                        <th>{dashboardCopy.category}</th>
                        <th>{dashboardCopy.amount}</th>
                      </tr>
                    </thead>
                    <tbody>
                      {recentTransactions.map((row, index) => {
                        ...
                        return (
                          <tr key={String(row.id ?? index)}>
                            <td>
                              {rowText(row, ["transaction_date", "date"])}
                            </td>
                            <td>
                              <span
                                className={
                                  isIncome ? "tag income" : "tag expense"
                                }
                              >
                                {isIncome ? text.income : text.expenses}
                              </span>
                            </td>
                            <td>
                              {rowText(row, [
            ...
            <div className="bk-rightcol">
              <div className="bk-panel">
                ...
                <div className="bk-taxrows">
                  <div>
                    <span>{dashboardCopy.gstCollected}</span>
                    <b>{money(taxTotals.gstCollected)}</b>
                  </div>
                  <div>
                    <span>{dashboardCopy.qstCollected}</span>
                    <b>{money(taxTotals.qstCollected)}</b>
                  </div>
                  <div>
                    <span>{dashboardCopy.gstCredits}</span>
                    <b>-{money(taxTotals.gstCredits)}</b>
                  </div>
                  <div>
                    <span>{dashboardCopy.qstCredits}</span>
                    <b>-{money(taxTotals.qstCredits)}</b>
                  </div>
                  <div className="total">
                    <span>{dashboardCopy.balance}</span>
                    <b>{money(taxBalance)}</b>
                  </div>
                </div>
              </div>
              ...
              <div className="bk-panel">
                <div className="bk-panelhead">
                  <h2>▰ {dashboardCopy.recentDocs}</h2>
                  <Link
                    href={`/tenue-de-livres/documents?lang=${lang}&year=${selectedYear}`}
                  >
                    {dashboardCopy.seeAll}
                ...
                {recentDocuments.length === 0 ? (
                  <div className="bk-empty">{dashboardCopy.noDocuments}</div>
                ) : (
                  <div className="bk-doclist">
                    {recentDocuments.map((doc, index) => (
                      <div key={String(doc.id ?? index)}>
                        ...
                        <b>
                          {rowText(
                            doc,
                            ["file_name", "filename", "name", "original_name"],
                            `Document ${index + 1}`
                          )}
                        </b>
                        <small>
                          {rowText(doc, ["created_at"], "").slice(0, 10)}
                        </small>
                      </div>
                    ))}
                  </div>
      ...
      <style jsx global>{`
        ...
        .bk-sidebar {
          width: 250px;
          background: linear-gradient(180deg, #17263a 0%, #142236 100%);
          color: #fff;
          position: fixed;
          inset: 0 auto 0 0;
        ...
        .bk-nav a:hover,
        .bk-sidebottom a:hover,
        .bk-sidebottom button:hover {
        ...
        .bk-summary.income {
          background: linear-gradient(135deg, #f5fffa, #effcf5);
        }
        .bk-summary.expense {
        ...
        .bk-summary.income .bk-summaryicon {
          background: #d9f7e7;
          color: #079447;
        }
        .bk-summary.expense .bk-summaryicon {
          background: #ffdede;
          color: #dc2626;
        }
        .bk-summary.result .bk-summaryicon {
          background: #dcecff;
          color: #1264d5;
        }
        .bk-summary.docs .bk-summaryicon {
          background: #fff0cc;
          color: #e99b00;
        }
        .bk-summary b {
        ...
        .bk-action:nth-child(1) > b {
          background: #eafaf2;
          color: #087a3d;
        }
        .bk-action:nth-child(2) > b {
          background: #fff0f0;
          color: #c81e1e;
        }
        .bk-action:nth-child(3) > b {
          background: #fff7e8;
          color: #a46100;
        }
        .bk-lowergrid {
...
function BookkeepingChat({
  ...
  const copy = {
    ...
    en: {
      ...
      hello: "Hello! 👋 Ask me your bookkeeping question.",
    ...
    es: {
      ...
      hello: "¡Hola! 👋 Hágame su pregunta sobre contabilidad.",
...
function PlanCard({
  ...
  async function startCheckout() {
    try {
      ...
      sessionStorage.setItem("bookkeeping_checkout_plan", plan);
  ...
  return (
    <section
      style={{
        background: "#ffffff",
        border: featured ? "2px solid #004aad" : "1px solid #dbe5f1",
        borderRadius: 18,
        padding: 26,
        boxShadow: featured
    ...
    >
      ...
      >
        <strong style={{ fontSize: 34, color: "#004aad" }}>{price}</strong>
