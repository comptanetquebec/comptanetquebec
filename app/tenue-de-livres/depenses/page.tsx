...
export default function DepensesPage() {
  ...
  const copy = {
    fr: {
      ...
      fiscalCategoryAi: "Suggestion automatique",
      ...
      documentTitle: "Importer une dépense à partir d’un document",
      documentText: "Déposez une facture, un reçu, une preuve de paiement ou une photo. Le document est analysé, puis vous vérifiez la dépense avant de la confirmer.",
    ...
    en: {
      ...
      fiscalCategoryAi: "Automatic suggestion",
      ...
      documentTitle: "Import an expense from a document",
      documentText: "Upload an invoice, receipt, proof of payment or photo. The document is analyzed, then you review the expense before confirming it.",
    ...
    es: {
      ...
      fiscalCategoryAi: "Sugerencia automática",
      ...
      documentTitle: "Importar gastos desde un documento",
      documentText: "Suba una factura, un recibo, un comprobante de pago o una foto. El documento se analiza y usted verifica el gasto antes de confirmarlo.",
