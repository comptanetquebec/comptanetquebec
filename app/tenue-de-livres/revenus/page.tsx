...
export default function RevenusPage() {
  ...
  const copy = {
    fr: {
      ...
      documentTitle: "Importer un revenu à partir d’un document",
      documentText: "Déposez une facture, un relevé, une preuve de paiement ou une photo. Le document est analysé, puis vous vérifiez le revenu avant de le confirmer.",
    ...
    en: {
      ...
      documentTitle: "Import income from a document",
      documentText: "Upload an invoice, statement, proof of payment or photo. The document is analyzed, then you review the income before confirming it.",
    ...
    es: {
      ...
      documentTitle: "Importar ingresos desde un documento",
      documentText: "Suba una factura, un estado, un comprobante de pago o una foto. El documento se analiza y usted verifica el ingreso antes de confirmarlo.",
