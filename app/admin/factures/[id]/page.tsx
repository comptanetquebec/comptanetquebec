...
export default async function FacturePage({
  ...
  const estPayee = facture.statut === "paid";
          ...
          <div className="border-t-8 border-blue-800 p-8 md:p-12">
            ...
            <div className="flex flex-col justify-between gap-8 md:flex-row">
              ...
              <div>
                ...
                <div className="mt-6 space-y-1 text-sm text-slate-600">
                  <div>849, boulevard Pie-XII</div>
                  <div>Québec (Québec) G1X 3T2</div>
                  <div>581-985-2599</div>
                  <div>comptanetquebec@gmail.com</div>
                </div>
              </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="px-5 py-5 text-right">
                      {money(facture.prix_unitaire, lang)}
                    </td>
            ...
            <div className="mt-8 ml-auto max-w-sm">
              ...
              <div className="flex justify-between py-2 text-slate-600">
                ...
                <span>{money(facture.sous_total, lang)}</span>
              </div>

              <div className="flex justify-between py-2 text-slate-600">
                <span>{L.gst}</span>
                <span>{money(facture.tps, lang)}</span>
              </div>

              <div className="flex justify-between py-2 text-slate-600">
                <span>{L.qst}</span>
                <span>{money(facture.tvq, lang)}</span>
              </div>
            ...
            <div className="mt-10 border-t border-slate-200 pt-6 text-xs text-slate-500">
              <div>TPS : 701807737</div>
              <div>TVQ : 1227932399</div>
            </div>
