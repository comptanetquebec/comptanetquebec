...
type CardText = { title: string; desc: string; cta: string };
type Dict = {
  title: string;
  intro: string;
  t1: CardText;
...
/* ---------- Card ---------- */
type CardProps = { title: string; desc: string; cta: string; onClick: () => void };

function Card({ title, desc, cta, onClick }: CardProps) {
  return (
    <div className="card" style={{ padding: 18, display: "flex", flexDirection: "column", gap: 10, minHeight: 170 }}>
