...
const COPY: Record<Lang, Copy> = {
  fr: {
    ...
    disclaimerTop:
      "Le prix final est confirmé après une courte revue de votre dossier.",
    disclaimerBottom:
      "Prix avant taxes. Les dossiers comportant des particularités peuvent nécessiter une évaluation supplémentaire.",
  ...
  en: {
    ...
    disclaimerTop:
      "Final pricing is confirmed after a brief review of your file.",
    disclaimerBottom:
      "Prices before taxes. Files with specific circumstances may require an additional assessment.",
    back: "Back to Home",
  ...
  es: {
    ...
    disclaimerTop:
      "El precio final se confirma después de una breve revisión del expediente.",
    disclaimerBottom:
      "Precios antes de impuestos. Algunos casos pueden requerir una evaluación adicional.",
