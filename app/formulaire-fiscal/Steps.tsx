...
export default function Steps({ step, lang, fid, type }: Props) {
  ...
  const href4 = buildHref("/formulaire-fiscal/confirmation", lang, fid, type);

  return (
    <div className="ff-steps" aria-label="Étapes du dossier">
      <Link
        href={href1}
        className={`ff-step ${step === 1 ? "ff-step-active" : ""}`}
      >
      ...
      <Link
        href={href2}
        className={`ff-step ${step === 2 ? "ff-step-active" : ""}`}
      >
      ...
      <Link
        href={href3}
        className={`ff-step ${step === 3 ? "ff-step-active" : ""}`}
      >
      ...
      <Link
        href={href4}
        className={`ff-step ${step === 4 ? "ff-step-active" : ""}`}
      >
